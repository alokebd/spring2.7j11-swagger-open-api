...
public class AuthorControllerTest {
    ...
    public void createAuthorShouldReturn201() throws Exception {
        ...
        //given
        AuthorDto authorDto = AuthorDto.builder().email("test@com.vision.api.com").firstName("Test").lastName("Surname").build();
    ...
    public void createExistingAuthorIdShouldReturn404() throws Exception {
        ...
        AuthorDto author1 = AuthorDto.builder().id(existingAuthorId).email("test@com.vision.api.com").firstName("Test").lastName("Surname").build();
